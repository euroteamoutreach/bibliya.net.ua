...
const config = {
  ...
  // Required
  params: {
    Bucket: process.env.BIBLIYA_BUCKET_NAME,
  },
  credentials: {
    accessKeyId: process.env.ETO_AWS_ACCESS_KEY_ID,
    secretAccessKey: process.env.ETO_AWS_SECRET_ACCESS_KEY,
    signatureVersion: 'v3',
  },

  // Optional
  deleteOldVersions: false, // NOT FOR PRODUCTION
  distribution: process.env.BIBLIYA_CLOUDFRONT, // CloudFront distribution ID
  region: process.env.BIBLIYA_DEFAULT_REGION,
